...
**Rule:** Never use em dashes (—). Replace every occurrence with commas, periods, colons, parentheses, or restructured sentences. There are zero acceptable uses of em dashes in humanized output.
